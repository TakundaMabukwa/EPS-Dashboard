...
export default function ExecutiveReportPage() {
  const [view, setView] = useState<"live" | "full">("live");
  const data = mockData;
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-gray-900">Fleet Control Overview</h1>
          <p className="text-xs text-gray-500">Real-time operational status for Terminal HQ</p>
        </div>
            ...
            <div className="flex gap-1">
              <button
                ...
                className={`rounded px-2.5 py-1 text-xs font-medium ${
                  view === "live" ? "bg-gray-900 text-white" : "text-gray-500 hover:bg-gray-100"
                }`}
              >
                Live View
              </button>
              <button
                ...
                className={`rounded px-2.5 py-1 text-xs font-medium ${
                  view === "full" ? "bg-gray-900 text-white" : "text-gray-500 hover:bg-gray-100"
                }`}
              >
                Full Map
              </button>
