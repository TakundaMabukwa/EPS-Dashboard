...
export const PAGES = {
  ...
  reports: { name: 'Reports', path: '/reports', description: 'Load schedule and broker reports' },
  uploads: { name: 'Upload Data', path: '/loadschedule/upload', description: 'Upload raw loadschedule data via Excel' },
  stopPoints: { name: 'Stop Points', path: '/load-plan', description: 'Manage stop points and rest areas' },
  inspections: { name: 'Inspections', path: '/fleetManager/inspections', description: 'Manage vehicle inspections and compliance' },
  clients: { name: 'Clients', path: '/clients', description: 'Manage client records and geozones' },
...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, Permission[]> = {
  admin: [
    ...
    { page: 'stopPoints', actions: ['view', 'create', 'edit', 'delete'] },
