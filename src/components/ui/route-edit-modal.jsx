      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          <p className="text-sm text-gray-600">
            Reorder stops using arrow buttons. Changes will recalculate the route.
          </p>
          
          <div className="space-y-2">
            {localStopPoints.length === 0 ? (
              ...
              localStopPoints.map((stopId, index) => (
                <div key={index} className="flex items-center gap-2 p-2 border rounded">
                  <span className="text-sm font-medium w-6">{index + 1}.</span>
                  <span className="flex-1 text-sm">{getStopName(stopId)}</span>
          ...
          <div className="flex gap-2 pt-4">
            ...
            <Button
              onClick={() => onReorder({ stopPoints: localStopPoints })}
              className="flex-1"
            >
              Apply Changes
            </Button>
